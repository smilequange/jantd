...
import cn.jantd.modules.shiro.authc.ShiroRealm;
import cn.jantd.modules.shiro.authc.aop.JwtFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 模板测试
        filterChainDefinitionMap.put("/test/jeecgDemo/demo3", "anon");
        // redis测试
        filterChainDefinitionMap.put("/test/jeecgDemo/redisDemo/**", "anon");
        ...
        // 未授权界面返回JSON
        shiroFilterFactoryBean.setUnauthorizedUrl("/sys/core/403");
        shiroFilterFactoryBean.setLoginUrl("/sys/core/403");
