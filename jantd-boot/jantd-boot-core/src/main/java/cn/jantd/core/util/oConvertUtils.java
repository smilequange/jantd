...
public class oConvertUtils {
    ...
    public static boolean isEmpty(Object object) {
        ...
        if (CoreConstant.NULL.equals(object)) {
            return (true);
        }
        return (false);
    }
    ...
    public static boolean isNotEmpty(Object object) {
        if (object != null && !"".equals(object) && !CoreConstant.NULL.equals(object)) {
            return (true);
        }
        return (false);
    }
    ...
    public static String getIpAddrByRequest(HttpServletRequest request) {
        ...
        if (ip == null || ip.length() == 0 || CoreConstant.UNKNOWN.equalsIgnoreCase(ip)) {
    ...
    public static String camelName(String name) {
        ...
        if (name == null || name.isEmpty()) {
            // 没必要转换
            return "";
        } else if (!name.contains(CoreConstant.CROSS_BAR)) {
            // 不含下划线，仅将首字母小写
    ...
    public static String camelToUnderline(String para) {
        if (para.length() < CoreConstant.NUMBER_THREE) {
